...
public:
    int subarraySum(vector<int>& nums, int k) {
        ...
        if (nums.size()==1 and k==nums[0]) {
            return 1;
        }else if (nums.size()==1 and k!=nums[0]){
            return 0;
        }
