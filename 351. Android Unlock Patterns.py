...
One of the invalid case can be: I want to create a pattern using 1 and 3. First you touch 1, 
  moving your finger to the right to reach 3 — oh no, there is 2 in the middle that we don’t 
  want it in my password! Here are all the invalid patterns:
