...
If two such substrings overlap, you need to wrap them together by only one pair 
...
https://shareablecode.com/snippets/add-bold-tag-in-string-python-solution-leetcode-KdxM-WmgU
