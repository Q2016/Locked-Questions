...
Methodology
This question can be solved by Depth First Search and It is similar with question 200. Number of 
Islands.The difference if to find the number of distinct islands
