...
Solution:   DP + Prefix sum + Binary search

Use dynamic programming to store the prefix sum. Since value in matrix is positive, 
so we can use binary search to find the appropriate square length k.
