...
We count the number of such combinations for each i, so that we can reduce the problem to 2Sum smaller. For 2Sum Smaller, 
we initialize two indices, left and right, pointing to the first and last element respectively. 
